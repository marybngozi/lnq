...
<body class="container-fluid" id="mybody">
    ...
    <header class="navbar-fixed-top" id="myheader">
        <div class="popup">Requests
            <span class="popuptext" id="myPopup"><?php echo getRequests();?></span>
        </div>
    ...
    <main class="row">
        <div class="col-sm-12" id="contentArea">
            <?php echo showFriends();?>
        </div>
        <div class="modal fade customModal" id="briefModal2" role="dialog">
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" id="reqAccept" >Accept Request</button>
    ...
    <footer class="row customNavBar">
        <div class="col-xs-12">
            <div class="col-xs-4"><a href="userhome.php" id="Cactive"><i class="fa fa-commenting"></i> CHATS</a></div>
